...
def init_cache():
    ...
    cache_file = os.path.expanduser("_img2gpx_cache.pkl")
...
first_end_clip = ImageClip(first_img).set_duration(duree_image*2)
...
clip_final.write_videofile(f"{output_folder}/video.mp4", codec="libx264", fps=24)        